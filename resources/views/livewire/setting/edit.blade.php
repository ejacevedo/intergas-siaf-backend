            ...
            <div class="max-w-xl">
                ...
                <form wire:submit.prevent="save" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <!-- <label class="block font-medium text-sm text-gray-700" for="file_routes">{{ __('Load file of routing - expenses') }} </label> -->
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @if (session('status') === 'updated')
                            ...
                            >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="aiz flex-shrink-0 inline w-6 h-6 mr-1"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path></svg> 
                            {{ __('Saved.') }}
                        </p>
                        @endif
