            ...
            <div class="bg-white overflow-hidden shadow sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <main class="grid min-h-full place-items-center text-center bg-white px-6 py-24 sm:py-32 lg:px-8">
                        <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" class="h-8 w-8 mb-4">
                            <path d="m13 13 6 6m0-6-6 6m15-3c0 6.627-5.373 12-12 12S4 22.627 4 16 9.373 4 16 4s12 5.373 12 12Z" stroke="#CBD5E1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
