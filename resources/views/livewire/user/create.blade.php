        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="max-w-xl">
                ...
                <form wire:submit.prevent="save" class="mt-6 space-y-6" autocomplete="nope">
                    ...
                    <div>
                        <div class="relative">
                            <input autocomplete="nope" type="text" id="name" class="shadow-sm p-4 block w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " id="name"  wire:model.defer="user.name"/>
