...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-orange-400 text-left text-base font-medium text-gray-700 bg-orange-50 focus:outline-none focus:text-gray-800 focus:bg-orange-100 focus:border-orange-700 transition duration-150 ease-in-out'
