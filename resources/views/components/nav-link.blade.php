...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 sm:px-6 text-base font-medium leading-5 text-gray-900 focus:outline-none focus:border-orange-700 transition duration-150 ease-in-out bg-orange-50 item'
